package com.tokoretro.app.data.local
...
import com.tokoretro.app.util.getObject
import com.tokoretro.app.util.putObject
...
class AuthPref(val context:Context) {
    ...
    suspend fun login(email: String, password: String): ActionState<AuthUser>{
        ...
        return if(user == null){
            ...
            isLogin = true
            ActionState(authUser, "Anda berhasil login")
        }else{
